...
//	@OneToMany
//	private Collection<Transactions> SoldCars=new ArrayList<>();
//	
	@OneToMany
	@JsonIgnore
	...
	public Admin(Integer id, String username, String email, String phone, String password, UserAddress userAddress,
			String image, String role, Collection<Inventory> inventory) {
		super();
		this.id = id;
